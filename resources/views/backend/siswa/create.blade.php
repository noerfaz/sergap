...
@section('konten')
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="row">
            <div class="col-md-6">
                <div class="card">
                    <h5 class="card-header">Tambah Napi</h5>
                    <div class="card-body">
                        <form action="" id="submitGelang">
                            <div class="row mb-3">
                                <label class="col-sm-3 col-form-label">Scan Gelang</label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="id_gelang" id="id_gelang">
                                </div>
                            </div>
                        </form>
                    </div>
                </div>
                <div class="card mb-4 mt-4" id="boxData">
                    <div class="card-body">
                        ...
                        <form action="{{ route('siswa.store') }}" method="POST" enctype="multipart/form-data"
                            ...
                            <div class="row mb-3">
                                <label class="col-sm-3 col-form-label">Nomor gelang</label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="nomor_anggota" readonly>
                                </div>
                            </div>
                            <div class="row mb-3">
                                <label class="col-sm-3 col-form-label">ID Napi</label>
                                <div class="col-sm-9">
                            ...
                            <div class="row mb-3">
                                <label class="col-sm-3 col-form-label">Nomor Sel</label>
                                <div class="col-sm-9">
...
@section('script')
    ...
    <script>
        ...
        $(document).ready(function(){
            const idGelang = $('#id_gelang');
            const boxData = $('#boxData');
            $(idGelang).focus().val('');
            $(boxData).hide();

            $('#submitGelang').submit(function(e){
                e.preventDefault();

                $(idGelang).focus();
                $(boxData).show();
                $('input[name="nomor_anggota"]').val($(idGelang).val());
                $(idGelang).val('');
            })
        });
    </script>
