            ...
            <div class="card-body">
                <div class="row mb-4">
                    ...
                    <div class="col-sm-7 mt-2">
                        @permission('napi-create')
                            <a href="{{ route('siswa.create') }}" class="btn btn-sm btn-primary float-end">Tambah</a>
                        @endpermission

                        @permission('napi-print')
                            {!! exportBtn(['data', 'foto'], route('ajax-siswa'), 'DATA NAPI') !!}
                        @endpermission
                    </div>
                </div>
        ...
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modalDetailAnggotaLabel">DETAIL NAPI</h5>
                ...
                <div class="modal-body">
                    ...
                    @csrf
                    <div class="row mb-2">
                        <label class="col-sm-4 col-form-label" for="nama">nomor gelang</label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control dt_nomor_anggota" disabled>
                        </div>
                    </div>
                    <div class="row mb-2">
                        <label class="col-sm-4 col-form-label" for="nama">id napi</label>
                        <div class="col-sm-8">
                    ...
                    <div class="row mb-2">
                        <label class="col-sm-4 col-form-label" for="kelas">nomor sel</label>
                        <div class="col-sm-8">
