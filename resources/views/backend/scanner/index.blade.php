                ...
                <div class="row mb-4">
                    ...
                    <div class="col-sm-9 mt-2">
                        @permission('scanner-create')
                            <a href="{{ route('scanner.create') }}" class="btn btn-sm btn-primary float-end">Tambah</a>
                        @endpermission

                        @permission('scanner-print')
                            {!! exportBtn('data', route('ajax-scanner'), 'DATA SCANNER') !!}
                        @endpermission
                    </div>
                </div>
